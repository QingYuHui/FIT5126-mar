...
#
python main_mar.py --evaluate --model mar_base --diffloss_d 6 --diffloss_w 1024 --vae_path pretrained_models/vae/kl16.ckpt --resume checkpoints/mar_base --output_dir output_results --data_path dummy_data --eval_bsz 4 --num_images 4 --num_iter 256 --num_sampling_steps 100 --cfg 2.9 --cfg_schedule linear --temperature 1.0
